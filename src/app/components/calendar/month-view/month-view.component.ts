...
export class MonthViewComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  ngOnInit(): void {
    this.getCalendarMonthDaysOnly();
  }

  ngOnChanges(changes: SimpleChanges): void {
    if (changes['selectedDay']) {
      console.log('month-view ngOnChanges', changes['selectedDay']);
      this.getCalendarMonthDaysOnly();
    }
  }
